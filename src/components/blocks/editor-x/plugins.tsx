  ...
  return (
    <div className={cn('relative', wrapperClassName)}>
      <ToolbarPlugin>
        {({ blockType }) => (
          <div
            className="vertical-align-middle sticky top-0 z-10 flex items-center
              gap-2 overflow-auto p-1.5 pb-0.5"
          >
              ...
              <div className="" ref={onRef}>
                <ContentEditable
                  ...
                  className="ContentEditable__root relative block
                    h-[calc(100vh-90px)] min-h-72 overflow-auto px-8 py-4
                    focus:outline-none"
                />
              </div>
            </div>
      ...
      <ActionsPlugin>
        <div
          className="clear-both flex items-center justify-between gap-2
            overflow-auto p-1.5 pt-0"
        >
