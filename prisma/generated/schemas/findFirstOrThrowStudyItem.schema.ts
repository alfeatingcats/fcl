...
export const StudyItemFindFirstOrThrowSelectSchema: z.ZodType<Prisma.StudyItemSelect> = z.object({
...
export const StudyItemFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    title: z.boolean().optional(),
    description: z.boolean().optional(),
    descriptionText: z.boolean().optional(),
...
export const StudyItemFindFirstOrThrowSchema: z.ZodType<Prisma.StudyItemFindFirstOrThrowArgs> = z.object({ select: StudyItemFindFirstOrThrowSelectSchema.optional(), include: StudyItemIncludeObjectSchema.optional(), orderBy: z.union([StudyItemOrderByWithRelationInputObjectSchema, StudyItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: StudyItemWhereInputObjectSchema.optional(), cursor: StudyItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StudyItemScalarFieldEnumSchema, StudyItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StudyItemFindFirstOrThrowArgs>;

export const StudyItemFindFirstOrThrowZodSchema = z.object({ select: StudyItemFindFirstOrThrowSelectSchema.optional(), include: StudyItemIncludeObjectSchema.optional(), orderBy: z.union([StudyItemOrderByWithRelationInputObjectSchema, StudyItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: StudyItemWhereInputObjectSchema.optional(), cursor: StudyItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StudyItemScalarFieldEnumSchema, StudyItemScalarFieldEnumSchema.array()]).optional() }).strict();