...
export const StudyRepetitionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.StudyRepetitionSelect> = z.object({
...
export const StudyRepetitionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    repetitionNumber: z.boolean().optional(),
    scheduledAt: z.boolean().optional(),
    completedAt: z.boolean().optional(),
